		<form id="form_empty_wordpress_content" method="post">
			<?php wp_nonce_field( 'empty', 'fgp2wc_nonce_empty' ); ?>
			...
			<table class="form-table">
				<tr>
					...
					<td>
						<input type="radio" name="empty_action" id="empty_action_imported" value="imported" /> <label for="empty_action_imported"><?php _e('Remove only previously imported data', 'fg-prestashop-to-woocommerce'); ?></label><br />
						...
						<div class="submit_button_with_spinner">
							<?php submit_button( __('Empty WordPress content', 'fg-prestashop-to-woocommerce'), 'primary', 'empty', false ); ?>
