				...
				<tr class="test_media">
					...
					<td>
						<div class="submit_button_with_spinner">
							<?php submit_button( __('Test the media connection', 'fg-prestashop-to-woocommerce'), 'secondary', 'test_download', false ); ?>
							<span id="download_test_spinner" class="spinner"></span>
						</div>
						<div id="download_test_message" class="action_message"></div>
					</td>
				</tr>
